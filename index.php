...
<head>
    ...
    <title>Сайт знакомств - Макара</title>
    ...
    <div class="container-fluid p-0">
        ...
        <div id="carouselExampleIndicators" class="carousel slide w-100" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="./images/site_images/banner-2.jpg" alt="First slide">
                </div>
                ...
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-md-10 col-lg-8">
                            ...
                            <p class="mt-4 mb-4">
                                Макара – сеть знакомств, основанная больше 10 лет назад. 
								За это время благодаря порталу миллионы людей в 15 странах нашли отношения и вступили в брак. 
								Здесь вы можете не бояться осуждения.</p>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-sm-4">
                            ...
                            <h5>Готовы к серьёзным отношениям</h5>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            ...
                            <hr/>
                            <p>Ваши чаты на 100% безопасны и защищены нашим сквозным шифрованием.</p>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <h3 class="h4">Чат</h3>
                            <hr/>
                            <p>Сообщения могут быть отправлены другим участникам. Отправьте "привет" или просто подмигните, чтобы начать
							разговор.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mr-0">
            <section id="sec-testimonials" class="sec-testimonials w-100">
                <div class="container">
                    <h1 class="h4 mb-5 text-center">Отзывы</h1>
                        ...
                        <div class="carousel-inner" role="listbox">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <blockquote class="blockquote">
                                            <small>
                                                На Макара безумно много анкет людей, которые могли бы заинтересовать, даже иностранцев много. Я девушка очень общительная и стремящаяся постоянно развиваться. 
												Знакомлюсь с людьми из других стран, практикую английский, стараюсь завести как можно больше друзей. 
												Недавно начала путешествовать к ним в гости. Уже была в Венгрии и в Чехии. За возможности спасибо сайту Макара.
                                            </small>
                                            <footer class="blockquote-footer mt-2">Катя</footer>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <blockquote class="blockquote">
                                            <small>Благодаря этому сайту я нашла любовь всей своей жизни.</small>
                                            <footer class="blockquote-footer mt-2">Дарья</footer>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <blockquote class="blockquote">
                                            <small>Хотел найти образованную, интеллигентную женщину для совместной жизни. Регистрация на Макара подарила мне встречу с моей женой.
											Она, как и я, нечасто заглядывала на сайт, 
											но так получилось, что мы в одно и то же время стали играть в симпатии.
											Заметили друг друга одновременно. Встретились через неделю, через 4 месяца поженились.</small>
                                            <footer class="blockquote-footer mt-2">Александр</footer>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
