        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card card-signin flex-row my-5">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">Логин</h5>
                            <form class="form-signin" action="login.php" method="post" enctype="multipart/form-data">
                                <div class="form-label-group">
                                    ...
                                    <label for="inputUserame">Имя пользователя</label>
                                </div>
                               <hr>
                                ...
                                <button class="btn btn-lg btn-primary btn-block text-uppercase" name="Submit" type="submit">Войти</button>
                                <div class="sign-up">
