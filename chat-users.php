...
<div class="container-fluid wrapper">
    ...
    <div class="row mb-10">
        <div class="container">
            <h3 class="mt-10 text-center">Сообщения</h3>
            <div class="messaging">
                <div class="inbox_msg">
                                ...
                                <div class="row mb-10" style="margin-top:10px ">
                                    <div class="col-md-12">
                                        <div class="alert alert-primary text-center" role="alert">
                                           Никаких чатов не найдено! Начните общаться, нажав кнопку <strong><a
                                                        href="./view-profiles.php" class="alert-link">"Написать"</a></strong> на странице профилей!
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
